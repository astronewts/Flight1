...
void initialize_database()
{
  ...
  db[7] = {"int",8,thresholds.normal_transmit_period/1000,null_long,null_float,"Normal Trans Per [s]",0,1,0};
  db[8] = {"int",8,thresholds.load_shed_transmit_period/1000,null_long,null_float,"Loadshed Trans Per [s]",0,1,0};
  db[9] = {"int",8,thresholds.transit_transmit_period/1000,null_long,null_float,"Transit Trans Per [s]",0,1,0};
  db[10] = {"int",8,thresholds.emergency_transit_transmit_period/1000,null_long,null_float,"Emer Trans Per [s]",0,1,0};
  db[11] = {"int",8,thresholds.spare_transmit_period/1000,null_long,null_float,"Spare Trans Per [s]",0,1,0};
