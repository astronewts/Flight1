...
void initialize_database()
{
  ...
  db[6] = {"int",8,thresholds.load_shed_transmit_period,null_long,null_float/1000.0,"Loadshed Trans Per [s]",0,1,0};
  db[7] = {"int",8,thresholds.transit_transmit_period,null_long,null_float/1000.0,"Transit Trans Per [s]",0,1,0};
  db[8] = {"int",8,thresholds.emergency_transit_transmit_period/1000.0,null_long,null_float,"Emer Trans Per [s]",0,1,0};
  db[9] = {"int",8,thresholds.spare_transmit_period/1000,null_long,null_float,"Spare Trans Per [s]",0,1,0};
  db[10] = {"long",8,null_int,parameters.sd_card_write_period/1000,null_float,"SD Card Write Per [s]",0,1,0};
  db[11] = {"long",12,null_int,raw_telemetry_data.raw_battery_1_temp_1,null_float,"B 1 T 1 [C]",2,1,1};
  db[12] = {"long",12,null_int,raw_telemetry_data.raw_battery_1_temp_2,null_float,"B 1 T 2 [C]",2,1,1};
  db[13] = {"long",12,null_int,raw_telemetry_data.raw_battery_2_temp_1,null_float,"B 2 T 1 [C]",2,1,1};
  db[14] = {"long",12,null_int,raw_telemetry_data.raw_battery_2_temp_2,null_float,"B 2 T 2 [C]",2,1,1};
  db[15] = {"long",12,null_int,raw_telemetry_data.raw_inner_external_temp,null_float,"Inner Ext T [C]",2,1,0};
  db[16] = {"long",12,null_int,raw_telemetry_data.raw_outter_external_temp,null_float,"Outer Ext T [C]",2,1,0};
  db[17] = {"long",12,null_int,raw_telemetry_data.raw_internal_temp,null_float,"Int T [C]",2,1,1};
  db[18] = {"long",12,null_int,raw_telemetry_data.raw_air_pressure,null_float,"Air Pres [Pa]",3,1,0};
  db[19] = {"long",12,null_int,raw_telemetry_data.raw_analog_VIN_voltage,null_float,"VIN Voltage [V]",4,1,0};
  db[20] = {"float",32,null_int,null_long,telemetry_data.battery_1_charge_current,"B1 Charge Current [A]",0,1,0};
  db[21] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt1,"B1 Shunt V [V]",0,1,0};
  db[22] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt1,"B1 Bus V [B]",0,1,1};
  db[23] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt1,"B1 Load Voltage [V]",0,1,0};
  db[24] = {"float",32,null_int,null_long,telemetry_data.battery_2_charge_current,"B2 Charge Current [A]",0,1,0};
  db[25] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt2,"B2 Shunt V [V]",0,1,0};
  db[26] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt2,"B2 Bus V [V]",0,1,1};
  db[27] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt2,"B2 Load V [V]",0,1,0};
  db[28] = {"float",32,null_int,null_long,telemetry_data.sa_current,"SA Current [A]",0,1,0};
  db[29] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_sa,"SA Shunt V [V]",0,1,0};
  db[30] = {"float",32,null_int,null_long,telemetry_data.busvoltage_sa,"SA Bus V [V]",0,1,0};
  db[31] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_sa,"SA Load V [V]",0,1,0};
  db[32] = {"float",32,null_int,null_long,telemetry_data.load_path_current,"Loadpath Current [V]",0,1,0};
  db[33] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_load_path,"Loadpath Shunt V [V]",0,1,0};
  db[34] = {"float",32,null_int,null_long,telemetry_data.busvoltage_load_path,"Loadpath Bus V [V]",0,1,0};
  db[35] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_load_path,"Loadpath Load V [V]",0,1,0};
  db[36] = {"long",8,null_int,parameters.tlm_processing_period,null_float,"Tel Proc Per [s]",1,1,0};
  ...
  db[45] = {"float",32,null_int,null_long,gps_data.gps_speed,"GPS Speed [km/h]",0,1,0}; 
  db[46] = {"int",4,gps_data.gps_num_satellites,null_long,null_float,"GPS # of Sat [-]",0,1,0}; 
  db[47] = {"long",32,null_int,gps_data.gps_date,null_float,"GPS Date [-]",0,1,1}; 
  db[48] = {"long",32,null_int,gps_data.gps_time,null_float,"GPS Time [-]",0,1,1}; 
  ...
  db[56] = {"int",1,gps_data.gps_speed_valid,null_long,null_float,"GPS Speed Isvalid [-]",0,1,0};
  db[57] = {"int",1,gps_data.gps_num_satellites_valid,null_long,null_float,"GPS Satellites Isvalid [-]",0,1,0};
  ...
  db[82] = {"float",32,null_int,null_long,gyro.gyro_temp,"Gyro T [C]",0,1,0};
  db[83] = {"float",32,null_int,null_long,parameters.voltage_sanity_check_high,"Volt San Check High [V]",0,1,0};
  db[84] = {"float",32,null_int,null_long,parameters.voltage_sanity_check_low,"Volt San Check Low [V]",0,1,0};
  db[85] = {"float",32,null_int,null_long,parameters.charge_current_sanity_check_high,"Charge Cur Sanity High [A]",0,1,0};
  db[86] = {"float",32,null_int,null_long,parameters.charge_current_sanity_check_low,"Charge Cur Sanity Low [A]",0,1,0};
  db[87] = {"float",32,null_int,null_long,parameters.battery_1_recharge_ratio,"B 1 Recharge Ratio [-]",0,0,0};
  db[88] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_charging,"B 1 AH Charging [A]",0,1,0};
  db[89] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_discharging,"B 1 AH Discharging [A]",0,1,0};
  db[90] = {"float",32,null_int,null_long,parameters.battery_2_recharge_ratio,"B 2 Recharge Ratio [-]",0,0,0};
  ...
  db[93] = {"float",32,null_int,null_long,parameters.sa_amphrs,"SA Total Amp Hrs [A.h]",0,1,0};
  db[94] = {"float",32,null_int,null_long,parameters.load_amphrs,"Load Total Amp Hrs [A.h]",0,1,0};
  db[95] = {"int",16,parameters.battery_temperature_limit_high,null_long,null_float,"B Active T Lim High [C]",0,1,0};
  db[96] = {"int",16,parameters.battery_temperature_limit_low,null_long,null_float,"B Active T Lim Low [C]",0,1,0}; 
  db[97] = {"int",16,parameters.battery_temperature_sanity_check_high,null_long,null_float,"B T Sanity Check High [C]",0,1,0};
  db[98] = {"int",16,thresholds.normal_battery_temperature_limit_high,null_long,null_float,"B Normal T Lim High [C]",0,1,0};
  db[99] = {"int",16,thresholds.normal_battery_temperature_limit_low,null_long,null_float,"B Normal T Lim Low [C]",0,1,0};
  db[100] = {"int",16,thresholds.survival_battery_temperature_limit_high,null_long,null_float,"B Surv T Lim High [C]",0,1,0};
  db[101] = {"int",16,thresholds.survival_battery_temperature_limit_low,null_long,null_float,"B Surv T Lim Low [C]",0,1,0};         
  db[102] = {"int",16,parameters.battery_temperature_sanity_check_low,null_long,null_float,"B T Sanity Check Low [C]",0,1,0};     
  db[103] = {"float",32,null_int,null_long,parameters.low_voltage_limit_for_loadshed_entry,"Loadshed Entry Volt Lim [V]",0,1,0};      
  db[104] = {"float",32,null_int,null_long,parameters.low_voltage_limit_for_auto_cutdown,"Auto Cutdown Volt Lim [V]",0,1,0};
  db[105] = {"int",16,parameters.low_voltage_time_limit,null_long,null_float,"Low Volt Time until Cut-down [s]",0,1,0};
  db[106] = {"int",16,parameters.altitude_limit_low,null_long,null_float,"Alt Limit Low [ft]",0,1,0};
  db[107] = {"int",16,parameters.altitude_sanity_check_low,null_long,null_float,"Alt Sanity Check Low [ft]",0,1,0}; 
  db[108] = {"int",12,parameters.cutdown_pulse_width,null_long,null_float,"Pyro Pulse Width [s]",0,1,0};
  db[109] = {"int",12,parameters.camera_period,null_long,null_float,"Cam Per [s]",0,1,0};
  db[110] = {"int",12,parameters.camera_on_time,null_long,null_float,"Cam On Time [s]",0,1,0};
  ...
  db[118] = {"int",1,parameters.camera_enabled,null_long,null_float,"Cam Enabled [-]",0,1,0};
  db[119] = {"int",1,parameters.camera_status,null_long,null_float,"Cam Status [-]",0,1,0};
  db[120] = {"int",1,parameters.battery_1_temp_tlm_valid_flag,null_long,null_float,"B 1 T TLM Val Flag [-]",0,1,0};         
  db[121] = {"int",1,parameters.battery_2_temp_tlm_valid_flag,null_long,null_float,"B 2 T TLM Val Flag [-]",0,1,0}; 
  db[122] = {"int",1,parameters.battery_voltage_tlm_valid_flag,null_long,null_float,"Bus V TLM Val Flag [-]",0,1,0};
