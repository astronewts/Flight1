...
void initialize_database()
{
  ...
  db[20] = {"float",32,null_int,null_long,telemetry_data.battery_1_charge_current,"B 1 Charge Current [A]",0,1,0};
  db[21] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt1,"B 2 Charge Current [A]",0,1,0};
  db[22] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt1,"SA Current [A]",0,1,0};
  db[23] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt1,"Load Path Current [A]",0,1,0};
  db[24] = {"float",32,null_int,null_long,telemetry_data.battery_2_charge_current,"B1_shunt_V [V]",0,1,0};
  db[25] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt2,"B1_Bus_V [V]",0,1,1};
  db[26] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt2,"B1_load_V [V]",0,1,0};
  db[27] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt2,"B2_shunt_V [V]",0,1,0};
  db[28] = {"float",32,null_int,null_long,telemetry_data.sa_current,"B2_Bus_V [V]",0,1,1};
  db[29] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_sa,"B2_load_V [V]",0,1,0};
  db[30] = {"float",32,null_int,null_long,telemetry_data.busvoltage_sa,"SA_shuntV [V]",0,1,0};
  db[31] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_sa,"SA_busV [V]",0,1,0};
  db[32] = {"float",32,null_int,null_long,telemetry_data.load_path_current,"SA_load_V [V]",0,1,0};
  db[33] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_load_path,"Loadpath_shunt_V  [V]",0,1,0};
  db[34] = {"float",32,null_int,null_long,telemetry_data.busvoltage_load_path,"Loadpath_Bus_V    [V]",0,1,0};
  db[35] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_load_path,"Loadpath_load_V   [V]",0,1,0};
