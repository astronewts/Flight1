...
void initialize_database()
{
  ...
  db[21] = {"float",32,null_int,null_long,telemetry_data.battery_1_charge_current,"B1 Charge Current [A]",0,1,0};
  db[22] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt1,"B1 Shunt V [V]",0,1,0};
  db[23] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt1,"B1 Bus V [V]",0,1,1};
  db[24] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt1,"B1 Load Voltage [V]",0,1,0};
  db[25] = {"float",32,null_int,null_long,telemetry_data.battery_2_charge_current,"B2 Charge Current [A]",0,1,0};
  db[26] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_batt2,"B2 Shunt V [V]",0,1,0};
  db[27] = {"float",32,null_int,null_long,telemetry_data.busvoltage_batt2,"B2 Bus V [V]",0,1,1};
  db[28] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_batt2,"B2 Load V [V]",0,1,0};
  db[29] = {"float",32,null_int,null_long,telemetry_data.sa_current,"SA Current [A]",0,1,0};
  db[30] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_sa,"SA Shunt V [V]",0,1,0};
  db[31] = {"float",32,null_int,null_long,telemetry_data.busvoltage_sa,"SA Bus V [V]",0,1,0};
  db[32] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_sa,"SA Load V [V]",0,1,0};
  db[33] = {"float",32,null_int,null_long,telemetry_data.load_path_current,"Loadpath Current [V]",0,1,0};
  db[34] = {"float",32,null_int,null_long,telemetry_data.shuntvoltage_load_path,"Loadpath Shunt V [V]",0,1,0};
  db[35] = {"float",32,null_int,null_long,telemetry_data.busvoltage_load_path,"Loadpath Bus V [V]",0,1,0};
  db[36] = {"float",32,null_int,null_long,telemetry_data.loadvoltage_load_path,"Loadpath Load V [V]",0,1,0};
  ...
  db[41] = {"float",32,null_int,null_long,gps_data.max_gps_altitude,"Max GPS Alt [m]",0,1,0}; 
  db[42] = {"float",32,null_int,null_long,gps_data.min_gps_altitude,"Min GPS Alt [m]",0,1,0};  
  ...
  db[53] = {"int",8,gps_data.gps_failed_checksum,null_long,null_float,"GPS Failed Checksum [-]",0,1,0};             
  db[54] = {"int",1,gps_data.gps_location_valid,null_long,null_float,"GPS Location Isvalid [-]",0,1,0};
  db[55] = {"int",1,gps_data.gps_altitude_valid,null_long,null_float,"GPS Alt Isvalid [-]",0,1,0};
  ...
  db[62] = {"float",32,null_int,null_long,gyro.max_ax,"Max Acc X [g]",0,1,0};   
  db[63] = {"float",32,null_int,null_long,gyro.min_ax,"Min Acc X [g]",0,1,0}; 
  db[64] = {"float",32,null_int,null_long,gyro.mean_ax,"Mean Acc X [g]",0,1,0}; 
  db[65] = {"float",32,null_int,null_long,gyro.max_ay,"Max Acc Y [g]",0,1,0};   
  db[66] = {"float",32,null_int,null_long,gyro.min_ay,"Min Acc Y [g]",0,1,0}; 
  db[67] = {"float",32,null_int,null_long,gyro.mean_ay,"Mean Acc Y [g]",0,1,0};
  db[68] = {"float",32,null_int,null_long,gyro.max_az,"Max Acc Z [g]",0,1,0};   
  db[69] = {"float",32,null_int,null_long,gyro.min_az,"Min Acc Z [g]",0,1,0}; 
  db[70] = {"float",32,null_int,null_long,gyro.mean_az,"Mean Acc z [g]",0,1,0};
  db[71] = {"float",32,null_int,null_long,gyro.max_gx,"Max Gyro X [deg/s]",0,1,0};   
  db[72] = {"float",32,null_int,null_long,gyro.min_gx,"Min Gyro X [deg/s]",0,1,0}; 
  db[73] = {"float",32,null_int,null_long,gyro.mean_gx,"Mean Gyro X [deg/s]",0,1,0}; 
  db[74] = {"float",32,null_int,null_long,gyro.max_gy,"Max Gyro Y [deg/s]",0,1,0};   
  db[75] = {"float",32,null_int,null_long,gyro.min_gy,"Min Gyro Y [deg/s]",0,1,0}; 
  db[76] = {"float",32,null_int,null_long,gyro.mean_gy,"Mean Gyro Y [deg/s]",0,1,0}; 
  db[77] = {"float",32,null_int,null_long,gyro.max_gz,"Max Gyro Z [deg/s]",0,1,0};   
  db[78] = {"float",32,null_int,null_long,gyro.min_gz,"Min Gyro Z [deg/s]",0,1,0}; 
  db[79] = {"float",32,null_int,null_long,gyro.mean_gz,"Mean Gyro Z [deg/s]",0,1,0};     
  ...
  db[99] = {"int",16,thresholds.normal_battery_temperature_limit_high,null_long,null_float,"B Norm T Lim High [C]",0,1,0};
  db[100] = {"int",16,thresholds.normal_battery_temperature_limit_low,null_long,null_float,"B Norm T Lim Low [C]",0,1,0};
  ...
  db[106] = {"int",16,parameters.low_voltage_time_limit,null_long,null_float,"Low Volt Time until Cutdown [s]",0,1,0};
  ...
  db[112] = {"int",1,parameters.battery_bus_low_voltage_flag,null_long,null_float,"Batt Bus Low V Flag",0,1,0};
  ...
  db[115] = {"int",1,parameters.cutdown_event_flag,null_long,null_float,"Cutdown Event Flag",0,1,0};
  db[116] = {"int",1,parameters.cutdown_1_status,null_long,null_float,"Cutdown 1 Fire Status",0,1,0};
  db[117] = {"int",1,parameters.cutdown_2_status,null_long,null_float,"Cutdown 2 Fire Status",0,1,0};
  ...
  db[121] = {"int",1,parameters.battery_1_temp_tlm_valid_flag,null_long,null_float,"B1 T TLM Val Flag",0,1,0};         
  db[122] = {"int",1,parameters.battery_2_temp_tlm_valid_flag,null_long,null_float,"B2 T TLM Val Flag",0,1,0}; 
  db[123] = {"int",1,parameters.battery_voltage_tlm_valid_flag,null_long,null_float,"Bus V TLM Val Flag",0,1,0};
  db[124] = {"int",1,parameters.battery_1_current_tlm_valid_flag,null_long,null_float,"B1 Cur TLM Val Flag",0,1,0};
  db[125] = {"int",1,parameters.battery_2_current_tlm_valid_flag,null_long,null_float,"B2 Cur TLM Val Flag",0,1,0};
  db[126] = {"float",32,null_int,null_long,alt.altitude_in_feet,"Alt [ft]",0,1,1};
  db[127] = {"float",32,null_int,null_long,alt.max_altitude_in_feet,"Max Alt [ft]",0,1,0}; 
  db[128] = {"float",32,null_int,null_long,alt.min_altitude_in_feet,"Min Alt [ft]",0,1,0}; 
  ...
  db[131] = {"float",32,null_int,null_long,alt.max_pressure,"Max Pressure [?]",0,1,0}; 
  db[132] = {"float",32,null_int,null_long,alt.min_pressure,"Min Pressure [?]",0,1,0}; 
  db[133] = {"int",8,parameters.num_rb_words_recieved,null_long,null_float,"RB Words Recieved",0,1,0}; 
  db[134] = {"int",8,parameters.invalid_command_recieved_count,null_long,null_float,"Invalid CMD Recieved Flag",0,1,0};
}
