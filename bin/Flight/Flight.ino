...
void initialize_database()
{
  ...
  db[10] = {"int",8,thresholds.emergency_transit_transmit_period/1000.0,null_long,null_float,"Emer Trans Per [s]",0,1,0};
  ...
  db[38] = {"long",8,null_int,parameters.tlm_processing_period,null_float,"Tel Proc Per [s]",1,1,0};
