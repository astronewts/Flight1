...
//  db[43] = {"int",4,(int*) &gps_data.gps_num_satellites,&null_long,&null_float,"GPS # of Sat [-]",0,1}; 
//  db[44] = {"long",32,&null_int,(long int*) &gps_data.gps_date,&null_float,"GPS Date [-]",0,1}; 
//  db[45] = {"long",32,&null_int,(long int*) &gps_data.gps_time,&null_float,"GPS Time [-]",0,1}; 
//  db[46] = {"int",32,(int*) &gps_data.gps_hdop,&null_long,&null_float,"HDOP Value [?]",0,1};
//  db[47] = {"int",32,(int*) &gps_data.gps_chars_processed,&null_long,&null_float,"GPS Chars Processed [-]",0,1};
//  db[48] = {"int",32,(int*) &gps_data.gps_sentances_with_fix,&null_long,&null_float,"GPS Sentences with Fix [-]",0,1}; 
//  db[49] = {"int",32,(int*) &gps_data.gps_failed_checksum,&null_long,&null_float,"GPS Failed Checksum [-]",0,1};
//  db[50] = {"int",1,(int*) &gps_data.gps_location_valid,&null_long,&null_float,"GPS Location Isvalid [-]",0,1};
//  db[51] = {"int",1,(int*) &gps_data.gps_altitude_valid,&null_long,&null_float,"GPS Altitude Isvalid [-]",0,1};
//  db[52] = {"int",1,(int*) &gps_data.gps_heading_valid,&null_long,&null_float,"GPS Course Isvalid [-]",0,1};
//  db[53] = {"int",1,(int*) &gps_data.gps_speed_valid,&null_long,&null_float,"GPS Speed Isvalid [-]",0,1};
//  db[54] = {"int",1,(int*) &gps_data.gps_num_satellites_valid,&null_long,&null_float,"GPS Satellites Isvalid [-]",0,1};
//  db[55] = {"int",1,(int*) &gps_data.gps_date_valid,&null_long,&null_float,"GPS Date Isvalid [-]",0,1};
//  db[56] = {"int",1,(int*) &gps_data.gps_time_valid,&null_long,&null_float,"GPS Time Isvalid [-]",0,1};
//  db[57] = {"int",1,(int*) &gps_data.gps_hdop_valid,&null_long,&null_float,"GPS HDOP Isvalid [-]",0,1};
...
//  db[105] = {"long",16,&null_int,(long int*) &parameters.low_voltage_time_limit,&null_float,"Low Volt Time until Cut-down [s]",0,1};
...
//  db[108] = {"long",12,&null_int,(long int*) &parameters.cutdown_pulse_width,&null_float,"Pyro Pulse Width [s]",0,1};
//  db[109] = {"long",12,&null_int,(long int*) &parameters.camera_period,&null_float,"Cam Per [s]",0,1};
//  db[110] = {"long",12,&null_int,(long int*) &parameters.camera_on_time,&null_float,"Cam On Time [s]",0,1};
//  db[111] = {"int",1,(int*) &parameters.battery_1_charging_status,&null_long,&null_float,"B 1 Charg Status [-]",0,1};
//  db[112] = {"int",1,(int*) &parameters.battery_2_charging_status,&null_long,&null_float,"B 2 Charg Status [-]",0,1};
//  db[113] = {"int",1,(int*) &parameters.battery_bus_low_voltage_flag,&null_long,&null_float,"Battery Bus Low V Flag [-]",0,1};
//  db[114] = {"int",1,(int*) &parameters.heater_state_1,&null_long,&null_float,"Heater State 1 [-]",0,1};
//  db[115] = {"int",1,(int*) &parameters.heater_state_2,&null_long,&null_float,"Heater State 2 [-]",0,1};
//  db[116] = {"int",1,(int*) &parameters.cutdown_enable_state,&null_long,&null_float,"Cut-down Enable [-]",0,1};
//  db[117] = {"int",1,(int*) &parameters.cutdown_1_status,&null_long,&null_float,"Cut-down 1 Fire Status [-]",0,1};
//  db[118] = {"int",1,(int*) &parameters.cutdown_2_status,&null_long,&null_float,"Cut-down 2 Fire Status [-]",0,1};
//  db[119] = {"int",1,(int*) &parameters.altitude_valid_flag,&null_long,&null_float,"Alt Valid Flag [-]",0,1};
//  db[120] = {"int",1,(int*) &parameters.camera_enabled,&null_long,&null_float,"Cam Enabled [-]",0,1};
//  db[121] = {"int",1,(int*) &parameters.camera_status,&null_long,&null_float,"Cam Status [-]",0,1};
//  db[122] = {"int",1,(int*) &parameters.battery_1_temp_tlm_valid_flag,&null_long,&null_float,"B 1 T TLM Val Flag [-]",0,1};         
//  db[123] = {"int",1,(int*) &parameters.battery_2_temp_tlm_valid_flag,&null_long,&null_float,"B 2 T TLM Val Flag [-]",0,1}; 
//  db[124] = {"int",1,(int*) &parameters.battery_voltage_tlm_valid_flag,&null_long,&null_float,"Bus V TLM Val Flag [-]",0,1};
//  db[125] = {"int",1,(int*) &parameters.battery_1_current_tlm_valid_flag,&null_long,&null_float,"B 1 Cur TLM Val Flag [-]",0,1};
//  db[126] = {"int",1,(int*) &parameters.battery_2_current_tlm_valid_flag,&null_long,&null_float,"B 2 Cur TLM Val Flag []",0,1};
...
void initialize_database_2()
{
  ...
  db[41] = {"float",32,null_int,null_long,gps_data.gps_location_age,"GPS Loc Age [s]",0,1,0};
  db[42] = {"float",32,null_int,null_long,gps_data.gps_altitude_age,"GPS Alt Age [s]",0,1,0};
  db[43] = {"float",32,null_int,null_long,gps_data.gps_heading,"GPS Course [deg]",0,1,0};
  db[44] = {"float",32,null_int,null_long,gps_data.gps_speed,"GPS Speed [km/h]",0,1,0}; 
  db[45] = {"int",4,gps_data.gps_num_satellites,null_long,null_float,"GPS # of Sat [-]",0,1,0}; 
  db[46] = {"long",32,null_int,gps_data.gps_date,null_float,"GPS Date [-]",0,1,1}; 
  db[47] = {"long",32,null_int,gps_data.gps_time,null_float,"GPS Time [-]",0,1,1}; 
  db[48] = {"int",32,gps_data.gps_hdop,null_long,null_float,"HDOP Value [?]",0,1,0};
  db[49] = {"int",32,gps_data.gps_chars_processed,null_long,null_float,"GPS Chars Processed [-]",0,1,0};
  db[50] = {"int",32,gps_data.gps_sentances_with_fix,null_long,null_float,"GPS Sentences with Fix [-]",0,1,0}; 
  db[51] = {"int",32,gps_data.gps_failed_checksum,null_long,null_float,"GPS Failed Checksum [-]",0,1,0};
  db[52] = {"int",1,gps_data.gps_location_valid,null_long,null_float,"GPS Location Isvalid [-]",0,1,0};
  db[53] = {"int",1,gps_data.gps_altitude_valid,null_long,null_float,"GPS Altitude Isvalid [-]",0,1,0};
  db[54] = {"int",1,gps_data.gps_heading_valid,null_long,null_float,"GPS Course Isvalid [-]",0,1,0};
  db[55] = {"int",1,gps_data.gps_speed_valid,null_long,null_float,"GPS Speed Isvalid [-]",0,1,0};
  db[56] = {"int",1,gps_data.gps_num_satellites_valid,null_long,null_float,"GPS Satellites Isvalid [-]",0,1,0};
  db[57] = {"int",1,gps_data.gps_date_valid,null_long,null_float,"GPS Date Isvalid [-]",0,1,0};
  db[58] = {"int",1,gps_data.gps_time_valid,null_long,null_float,"GPS Time Isvalid [-]",0,1,0};
  db[59] = {"int",1,gps_data.gps_hdop_valid,null_long,null_float,"GPS HDOP Isvalid [-]",0,1,0};
  db[60] = {"float",32,null_int,null_long,gyro.ax,"Acc X [g]",0,1,0};   
  db[61] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0}; 
  db[62] = {"float",32,null_int,null_long,gyro.ay,"Acc Y [g]",0,1,0}; 
  db[63] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0};
  db[64] = {"float",32,null_int,null_long,gyro.ax,"Acc X [g]",0,1,0};   
  db[65] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0}; 
  db[66] = {"float",32,null_int,null_long,gyro.ay,"Acc Y [g]",0,1,0}; 
  db[67] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0};
  db[68] = {"float",32,null_int,null_long,gyro.az,"Acc Z [g]",0,1,0};
  db[69] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0}; 
  db[70] = {"float",32,null_int,null_long,gyro.mx,"Gyro mag X [G]",0,1,0}; 
  db[71] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0};
  db[72] = {"float",32,null_int,null_long,gyro.my,"Gyro mag Y [G]",0,1,0}; 
  db[73] = {"float",32,null_int,null_long,null_float,"[n/a]",0,1,0};
  db[74] = {"float",32,null_int,null_long,gyro.mz,"Gyro mag Z [G]",0,1,0};  
  db[75] = {"float",32,null_int,null_long,gyro.gx,"Gyro X [deg/s]",0,1,0};  
  db[76] = {"float",32,null_int,null_long,gyro.gy,"Gyro Y [deg/s]",0,1,0}; 
  db[77] = {"float",32,null_int,null_long,gyro.gz,"Gyro Z [deg/s]",0,1,0};
  db[78] = {"float",32,null_int,null_long,gyro.gyro_temp,"Gyro T [C]",0,1,0};
  db[79] = {"float",32,null_int,null_long,parameters.voltage_sanity_check_high,"Volt San Check High [V]",0,1,0};
  db[80] = {"float",32,null_int,null_long,parameters.voltage_sanity_check_low,"Volt San Check Low [V]",0,1,0};
  db[81] = {"float",32,null_int,null_long,parameters.charge_current_sanity_check_high,"Charge Cur Sanity High [A]",0,1,0};
  db[82] = {"float",32,null_int,null_long,parameters.charge_current_sanity_check_low,"Charge Cur Sanity Low [A]",0,1,0};
  db[83] = {"float",32,null_int,null_long,parameters.battery_1_recharge_ratio,"B 1 Recharge Ratio [-]",0,1,0};
  db[84] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_charging,"B 1 AH Charging [A]",0,1,0};
  db[85] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_discharging,"B 1 AH Discharging [A]",0,1,0};
  db[86] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_term_threshold,"B 1 Cap Lim High [A.h]",0,1,0};
  db[87] = {"float",32,null_int,null_long,parameters.battery_1_amphrs_init_threshold,"B 1 Cap Lim Low [A.h]",0,1,0}; 
  db[88] = {"float",32,null_int,null_long,parameters.battery_1_voltage_term_threshold,"B 1 Volt Term. Charge Limit [V]",0,1,0};
  db[89] = {"float",32,null_int,null_long,parameters.battery_1_voltage_init_threshold,"B 1 Volt Init. Charge Limit [V]",0,1,0};
  db[90] = {"float",32,null_int,null_long,parameters.battery_2_recharge_ratio,"B 2 Recharge Ratio [-]",0,1,0};
  db[91] = {"float",32,null_int,null_long,parameters.battery_2_amphrs_charging,"B 2 Amp Hours Charging [A]",0,1,0};
  db[92] = {"float",32,null_int,null_long,parameters.battery_2_amphrs_discharging,"B 2 Amp Hours Discharging [A]",0,1,0};
  db[93] = {"float",32,null_int,null_long,parameters.battery_2_amphrs_term_threshold,"B 2 Cap Limit High [A.h]",0,1,0};
  db[94] = {"float",32,null_int,null_long,parameters.battery_2_amphrs_init_threshold,"B 2 Cap Limit Low [A.h]",0,1,0};
  db[95] = {"float",32,null_int,null_long,parameters.battery_2_voltage_term_threshold,"B 2 Volt Term. Charge Lim [V]",0,1,0};
  db[96] = {"float",32,null_int,null_long,parameters.battery_2_voltage_init_threshold,"B 2 Volt Init. Charge Lim [V]",0,1,0};  
  ...
  db[100] = {"int",16,thresholds.normal_battery_temperature_limit_high,null_long,null_float,"B Normal T Lim High [C]",0,1,0};
  ...
  db[118] = {"int",1,parameters.cutdown_enable_state,null_long,null_float,"Cut-down Enable [-]",0,1,0};
  db[119] = {"int",1,parameters.cutdown_1_status,null_long,null_float,"Cut-down 1 Fire Status [-]",0,1,0};
  db[120] = {"int",1,parameters.cutdown_2_status,null_long,null_float,"Cut-down 2 Fire Status [-]",0,1,0};
  db[121] = {"int",1,parameters.altitude_valid_flag,null_long,null_float,"Alt Valid Flag [-]",0,1,0};
  db[122] = {"int",1,parameters.camera_enabled,null_long,null_float,"Cam Enabled [-]",0,1,0};
  db[123] = {"int",1,parameters.camera_status,null_long,null_float,"Cam Status [-]",0,1,0};
  db[124] = {"int",1,parameters.battery_1_temp_tlm_valid_flag,null_long,null_float,"B 1 T TLM Val Flag [-]",0,1,0};         
  db[125] = {"int",1,parameters.battery_2_temp_tlm_valid_flag,null_long,null_float,"B 2 T TLM Val Flag [-]",0,1,0}; 
  db[126] = {"int",1,parameters.battery_voltage_tlm_valid_flag,null_long,null_float,"Bus V TLM Val Flag [-]",0,1,0};
  db[127] = {"int",1,parameters.battery_1_current_tlm_valid_flag,null_long,null_float,"B 1 Cur TLM Val Flag [-]",0,1,0};
  db[128] = {"int",1,parameters.battery_2_current_tlm_valid_flag,null_long,null_float,"B 2 Cur TLM Val Flag []",0,1,0};
