...
dummy_value=0;
    ...
    parameters.output_dataword = combine_float(32, raw_telemetry_data.battery_1_charge_current, parameters.output_dataword); //19
    parameters.output_dataword = combine_float(32, raw_telemetry_data.battery_2_charge_current, parameters.output_dataword); //20                            
    parameters.output_dataword = parameters.output_dataword + "000000000000";                                                //21
    parameters.output_dataword = parameters.output_dataword + "000000000000";                                                //22
