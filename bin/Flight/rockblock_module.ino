...
dummy_value=0;
    ...
    parameters.output_dataword = combine_float(32, telemetry_data.shuntvoltage_batt1, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.busvoltage_batt1, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.loadvoltage_batt1, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.battery_2_charge_current, parameters.output_dataword);                //20                            
    parameters.output_dataword = combine_float(32, telemetry_data.shuntvoltage_batt2, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.busvoltage_batt2, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.loadvoltage_batt2, parameters.output_dataword);                
    parameters.output_dataword = combine_float(32, telemetry_data.sa_current, parameters.output_dataword);                              //21
    parameters.output_dataword = combine_float(32, telemetry_data.shuntvoltage_sa, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.busvoltage_sa, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.loadvoltage_sa, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.load_path_current, parameters.output_dataword);                       //22 
    parameters.output_dataword = combine_float(32, telemetry_data.shuntvoltage_load_path, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.busvoltage_load_path, parameters.output_dataword);                //19
    parameters.output_dataword = combine_float(32, telemetry_data.loadvoltage_load_path, parameters.output_dataword); 
    ...
    parameters.output_dataword = combine_float(32, gyro.ax, parameters.output_dataword);                                     //40
    parameters.output_dataword = combine_float(32, dummy_value, parameters.output_dataword);                                 //41
    parameters.output_dataword = combine_float(32, gyro.ay, parameters.output_dataword);                                     //42
    parameters.output_dataword = combine_float(32, dummy_value, parameters.output_dataword);                                 //43
    parameters.output_dataword = combine_float(32, gyro.az, parameters.output_dataword);                                     //44
    parameters.output_dataword = combine_float(32, dummy_value, parameters.output_dataword);                                 //45
    parameters.output_dataword = combine_float(32, gyro.mx, parameters.output_dataword);                                     //46
    parameters.output_dataword = combine_float(32, dummy_value, parameters.output_dataword);                                 //47
    parameters.output_dataword = combine_float(32, gyro.my, parameters.output_dataword);                                     //48
    ...
    parameters.output_dataword = combine_float(32, gyro.gz, parameters.output_dataword);                                     //54
