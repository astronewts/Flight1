...
{ 
  ...
  B = dueMPU.printVector(dueMPU.m_rawMag);
  C = dueMPU.printVector(dueMPU.m_rawAccel);         
  D = dueMPU.printAngles(dueMPU.m_dmpEulerPose); 
  E = dueMPU.printVector(dueMPU.m_calAccel);       
  F = dueMPU.printVector(dueMPU.m_calMag); 
  G = dueMPU.printAngles(dueMPU.m_fusedEulerPose); 
